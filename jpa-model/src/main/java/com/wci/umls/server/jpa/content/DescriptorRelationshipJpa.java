...
public class DescriptorRelationshipJpa extends AbstractRelationship<Descriptor, Descriptor>
   ...
   */
  public DescriptorRelationshipJpa(DescriptorRelationship relationship, boolean collectionCopy) {
  ...
  public Relationship<Descriptor, Descriptor> createInverseRelationship(
    ...
    final DescriptorRelationship inverseRelationship =
        new DescriptorRelationshipJpa((DescriptorRelationship) relationship, false);
