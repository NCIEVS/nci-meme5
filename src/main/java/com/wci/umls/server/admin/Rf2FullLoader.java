...
/**
 * Admin tool which loads an RF2 Full release of SNOMED CT into a database.
 *
 * <p>Usage:
 * <pre>
 *   ./gradlew adminLoadRf2Full -Pterminology=SNOMEDCT_US -Pversion=latest \
 *       -Pinput.dir=/data/rf2 -Pserver=false -Pmode=create
 * </pre>
 */
public class Rf2FullLoader extends AbstractLoader {

  /** Logger. */
  private static final Logger LOG =
      Logger.getLogger(Rf2FullLoader.class.getName());
  ...
  public void run() throws Exception {
    ...
    LOG.info("RF2 Full Terminology Loader");
    ...
    if (!serverRunning) {
      ...
      client.loadTerminologyRf2Full(terminology, version, inputDir, authToken);
    }
  }
