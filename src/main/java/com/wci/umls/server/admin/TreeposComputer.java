...
/**
 * Admin tool which recomputes tree positions for a terminology.
 *
 * <p>Usage:
 * <pre>
 *   ./gradlew adminTreePositions -Pterminology=SNOMEDCT_US -Pversion=latest -Pserver=false
 * </pre>
 */
public class TreeposComputer {

  /** Logger. */
  private static final Logger LOG =
      Logger.getLogger(TreeposComputer.class.getName());
  ...
  public static void main(String[] args) throws Exception {
    ...
    LOG.info("Starting computation of tree positions");
