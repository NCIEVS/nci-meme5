 ...
 * approved, publishable, non RQ, SY, (maybe SFO/LFO), (non-weak) current
 * version <code>MSH</code> {@link Relationship}.
 *
 */
public class MGV_F extends AbstractValidationCheck {
  ...
  public ValidationResult validateAction(MolecularActionAlgorithm action) {
    ...
    // Go through all the publishable "MSH" atoms in source, and collect
