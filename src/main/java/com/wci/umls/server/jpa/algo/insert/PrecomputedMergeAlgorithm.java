...
public class PrecomputedMergeAlgorithm extends AbstractMergeAlgorithm {
  ...
  public void reset() throws Exception {
	 ...
	 * final PfsParameter pfs = new PfsParameterJpa(); pfs.setAscending(false);
	 * pfs.setSortField("lastModified"); final MolecularActionList molecularActions
	 ...
	 * { // Create and set up an undo action final UndoMolecularAction undoAction =
	 * new UndoMolecularAction();
	 * 
	 * // Configure and run the undo action undoAction.setProject(getProject());
	 ...
	 * undoAction.setForce(false); undoAction.performMolecularAction(undoAction,
