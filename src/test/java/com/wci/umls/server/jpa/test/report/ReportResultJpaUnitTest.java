...
import com.wci.umls.server.jpa.model.report.ReportResultItemJpa;
import com.wci.umls.server.jpa.model.report.ReportResultJpa;
 ...
 */
public class ReportResultJpaUnitTest extends ModelUnitSupport {

  /** The model object to test. */
  private ReportResultJpa object;
  ...
  public void testModelCollectionCopy() throws Exception {
    ...
    tester.proxy(ReportResultItem.class, 1, i1);
    tester.proxy(ReportResultItem.class, 2, i2);
    assertTrue(tester.testCopyConstructorCollection(ReportResult.class));
