...
import com.wci.umls.server.jpa.model.helpers.IndexedFieldTester;
import com.wci.umls.server.jpa.model.helpers.NullableFieldTester;

/**
 * Unit testing for {@link ProcessConfigJpa}.
 */
public class ProcessConfigJpaUnitTest extends ModelUnitSupport {

  /** The model object to test. */
  private ProcessConfigJpa object;
  ...
  /** The test fixture l1. */
  private List<AlgorithmConfig> l1;

  /** The test fixture l2. */
  private List<AlgorithmConfig> l2;
  ...
  public void setup() throws Exception {
    object = new ProcessConfigJpa();

    p1 = new ProjectJpa();
    p1.setId(1L);
    p2 = new ProjectJpa();
    p2.setId(2L);
    ProxyTester tester = new ProxyTester(new AlgorithmConfigJpa());
    l1 = new ArrayList<>();
    l1.add((AlgorithmConfig) tester.createObject(1));
    l2 = new ArrayList<>();
    l2.add((AlgorithmConfig) tester.createObject(2));
  }
  ...
  public void testModelCopy() throws Exception {
    ...
    assertTrue(tester.testCopyConstructor(ProcessConfig.class));
  }
  ...
  public void testModelXmlTransient() throws Exception {
    ...
    tester.proxy(List.class, 1, l1);
    tester.proxy(Project.class, 1, p1);
    final ProcessConfig config = (ProcessConfig) tester.createObject(1);
