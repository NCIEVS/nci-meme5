 ...
 */
public class MGV_BIT extends IntegrationUnitSupport {
  ...
  public void testNormalUse() throws Exception {
    ...
    action.setValidationChecks(new ArrayList<>(Arrays.asList("MGV_B")));
    ...
    action2.setValidationChecks(new ArrayList<>(Arrays.asList("MGV_B")));
