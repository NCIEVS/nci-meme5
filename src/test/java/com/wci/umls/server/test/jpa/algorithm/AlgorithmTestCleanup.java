...
public class AlgorithmTestCleanup extends IntegrationUnitSupport {
  ...
  public void testCleanup() throws Exception {
    ...
    List<Terminology> addedTerminologies = new ArrayList<>();
    for (Pair<String, String> terminologyVersion : addedTerminologyIds) {
      String terminologyString = terminologyVersion.getLeft();
      String version = terminologyVersion.getRight();
      Terminology terminology =
          contentService.getTerminology(terminologyString, version);
      if (terminology != null) {
        addedTerminologies.add(terminology);
      }
    }
    ...
    for (Terminology addedTerminology : new ArrayList<>(addedTerminologies)) {
