 ...
 */
public class SemanticTypeResolverAlgorithmIT extends IntegrationUnitSupport {
  ...
  public void setup() throws Exception {
    ...
    processExecution.setDescription("TESTProcessExecution");
    processExecution.setName("TESTProcessExecution");
  ...
  public void testSemanticTypeResolver() throws Exception {
    ...
    // Create a new SemanticTypeComponent and attach it to a stable concept,
    // so the resolver can identify and remove it.
