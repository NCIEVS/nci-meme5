...
import com.wci.umls.server.jpa.services.validation.MGV_SDUI;
import com.wci.umls.server.model.content.Atom;
import com.wci.umls.server.model.content.Concept;
import com.wci.umls.server.test.helpers.IntegrationUnitSupport;

/**
 * Integration testing for {@link MGV_SDUI}.
 */
public class MGV_SDUIIT extends IntegrationUnitSupport {
  ...
  public void setup() throws Exception {
    ...
    validationData.add(new TypeKeyValueJpa("MGV_SDUI", "MSH", ""));
  ...
  public void testNormalUse() throws Exception {
    ...
    //
    // Test violation of MGV_SDUI
    // Contained atoms from same specified terminology have different Descriptor IDs
    //
    ...
    //
    // Test non-violation of MGV_SDUI
    // All contained atoms from same specified terminology have same Descriptor IDs 
    //
