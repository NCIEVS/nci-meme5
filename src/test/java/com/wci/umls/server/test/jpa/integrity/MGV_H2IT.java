 ...
 */
public class MGV_H2IT extends IntegrationUnitSupport {
  ...
  public void testNormalUse() throws Exception {
    ...
    action.setValidationChecks(new ArrayList<>(Arrays.asList("MGV_H2")));
    ...
    // Verify that it returned a validation warning (MGV_H2 uses warnings)
    ...
    action2.setValidationChecks(new ArrayList<>(Arrays.asList("MGV_H2")));
    ...
    action3.setValidationChecks(new ArrayList<>(Arrays.asList("MGV_H2")));
