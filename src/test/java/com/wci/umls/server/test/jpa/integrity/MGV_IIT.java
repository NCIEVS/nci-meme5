 ...
 */
public class MGV_IIT extends IntegrationUnitSupport {
  ...
  public void testNormalUse() throws Exception {
    ...
    action.setValidationChecks(new ArrayList<>(Arrays.asList("MGV_I")));
    ...
    action2.setValidationChecks(new ArrayList<>(Arrays.asList("MGV_I")));
