 ...
 */
public class OwlLoadAndUnloadIT {
...
//   * Run the ClaML  mojo against the sample config/src/resources/data/snomed.owl" data.
//   *   TEST: verify each content table exists with the expected number of entries.
//   * Create an "SNOMEDCT" project (name="Sample Project" description="Sample project." terminology=SNOMEDCT version=latest scope.concepts=? scope.descendants.flag=true admin.user=admin)
...
//        "../../config/src/main/resources/data/snomed.owl");
//    request.setProperties(p);
//    invoker = new DefaultInvoker();
//    result = invoker.execute(request);
//    if (result.getExitCode() != 0) {
