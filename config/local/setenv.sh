...
export DB_ACQUIRE_INCREMENT="${DB_ACQUIRE_INCREMENT:-1}"
export DB_MAX_POOL_SIZE="${DB_MAX_POOL_SIZE:-64}"
export DB_MIN_POOL_SIZE="${DB_MIN_POOL_SIZE:-5}"
export DB_MAX_IDLE_TIME="${DB_MAX_IDLE_TIME:-3600}"
export DB_IDLE_TEST_PERIOD="${DB_IDLE_TEST_PERIOD:-1800}"
export DB_MAX_CONNECTION_AGE="${DB_MAX_CONNECTION_AGE:-3600}"
